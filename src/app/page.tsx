    ...
    <main className="page rel" style={{ minHeight: "calc(100vh - 84px)", paddingTop: 60 }}>
      <div className="cols" style={{ gridTemplateColumns: "minmax(0, 700px) 440px", gap: 80 }}>
        <div className="stack" style={{ gap: 22 }}>
          <h1 className="fell rv" style={{ fontSize: "clamp(36px, 5.5vw, 58px)", maxWidth: 680 }}>Keep an honest ledger of what you take from the world.</h1>
        ...
        <Paper tone="dark" rot={2} pin style={{ padding: 30 }}>
          <img src="/images/fern.jpg" alt="Engraving of a fern frond" style={{ width: "100%", height: "min(410px, 70vw)", objectFit: "cover", background: "var(--paper)" }} />
      ...
      <blockquote className="hand soft float-note" style={{ position: "absolute", right: 96, bottom: 70, width: 420, transform: "rotate(-2deg)", margin: 0 }}>
